//
//  ConnectionsSegmentedControl.swift
//  Loop Golf
//
...
@IBDesignable class ConnectionsSegmentedControl: UIControl {
    ...
    var items: [String] = ["Caddies", "Golfers"] {
        didSet {
            setupLabels()
        }
    }
    ...
    override func layoutSubviews() {
        ...
        lineView.frame = CGRect(x: (labelWidth * 0.1), y: labelHeight - 1.0, width: (labelWidth * 0.8), height: 1.5)
